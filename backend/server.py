...
async def seed_turtle_problems():
    ...
    try:
        # Check if NEW curriculum structure exists (Chapter 1: First Steps)
        new_structure_exists = await db.problems.find_one({"assignment_type": "turtle", "chapter": "Chapter 1: First Steps"})
