...
import { ArrowLeft, Lock, Mail, User, Building2, Briefcase } from "lucide-react";

const BACKEND_URL = process.env.REACT_APP_BACKEND_URL;
const API = `${BACKEND_URL}/api`;

export default function DistrictAdminSignup() {
  ...
  const handleSignup = async (e) => {
    ...
    if (!name || !email || !password || !confirmPassword || !district || !jobTitle) {
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-between">
            <CardTitle className="text-2xl font-bold">District Admin Signup</CardTitle>
          ...
          <CardDescription>
            Request district administrator access (requires approval)
          </CardDescription>
        </CardHeader>
        <CardContent>
