    ...
    return new Promise((resolve) => {
      ...
      switch (cmd.type) {
        ...
        case 'backward': {
          ...
          console.log(`[TURTLE] ${cmd.type}(${cmd.value}): heading=${turtle.heading.toFixed(1)}°, (${turtle.x.toFixed(1)}, ${turtle.y.toFixed(1)}) → (${newX.toFixed(1)}, ${newY.toFixed(1)})`);
        ...
        case 'goto':
          console.log(`[TURTLE] goto(${cmd.x}, ${cmd.y}): was at (${turtle.x.toFixed(1)}, ${turtle.y.toFixed(1)}), heading=${turtle.heading.toFixed(1)}°`);
          if (turtle.penDown) {
            pathsRef.current.push({
              type: 'line',
              x1: turtle.x, y1: turtle.y,
          ...
          turtle.x = cmd.x;
          turtle.y = cmd.y;
          console.log(`[TURTLE] goto complete: now at (${turtle.x}, ${turtle.y}), heading still ${turtle.heading.toFixed(1)}°`);
          drawCanvas();
          setTimeout(resolve, baseDelay);
          break;
